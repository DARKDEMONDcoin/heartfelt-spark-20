...
const solutions = [
  { icon: MessageSquareText, label: "المحتوى والنشر", title: "محتوى يعرف صوت علامتك.", body: "خطط ومنشورات جاهزة لكل منصة، مع مراجعتك قبل النشر.", image: dashboardAsset.url, to: "/employees/sonny" },
